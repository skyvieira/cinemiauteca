...
export const ShowPoster = styled.section`
    width: 20%;
    height: 100%;
    display: flex;
    align-items: center;
...
export const ShowSinopse = styled.section`
    width: 100%;
    height: 30%;
    display: flex;
    align-items: center;
    justify-content: flex-start;
    font : 400 1.1rem/2rem 'B612', sans-serif;
    color: #fff;
    text-align: justify;
`;

export const ShowReleaseDate = styled.section`
    width: 100%;
    height: 10%;
    display: flex;
